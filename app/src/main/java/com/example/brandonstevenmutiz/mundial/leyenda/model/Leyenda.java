package com.example.brandonstevenmutiz.mundial.leyenda.model;
...
public class Leyenda {
    ...
    public Leyenda(String nom_tipo, String nom_pregunta, String respuesta1, String respuesta2, String respuesta3, String respuesta4){
        this.nom_tipo = nom_tipo;
        this.nom_pregunta = nom_pregunta;
        this.respuesta1 = respuesta1;
        this.respuesta2 = respuesta2;
